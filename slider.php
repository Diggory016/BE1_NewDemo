                ...
                ?>
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        ...
                        <div class="overlay">
                            ...
                            <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="single.php?id=<?php echo $value['id'] ?>"><?php echo $value['name'] ?></a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
                        ...
                        <div class="col-md-6 px-0">
                            <div class="position-relative overflow-hidden" style="height: 250px;">
                                ...
                                <div class="overlay">
                                    ...
                                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="single.php?id=<?php echo $value['id'] ?>"><?php echo substr($value['name'], 0, 40) ?>... </a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
